...
output: $(OBJ)/main.o $(OBJ)/crc.o $(OBJ)/utils.o $(OBJ)/hdlc.o $(OBJ)/sem.o
	$(CC) $(FLAG) $(DEBUG) $(OBJ)/main.o $(OBJ)/crc.o $(OBJ)/utils.o $(OBJ)/hdlc.o $(OBJ)/sem.o -o output -lm
...
$(OBJ)/sem.o: $(SRC)/Semaphore/sem.c $(SRC)/Semaphore/sem.h
	$(CC) $(FLAG) $(DEBUG) -c $(SRC)/Semaphore/sem.c -o $(OBJ)/sem.o -lm
